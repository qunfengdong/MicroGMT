...
2. Exclude strains/IDs that are already exist in the pre-built summary tables for the new inputs (optional)<br>
...
4. Remove strains/IDs from summary tables  (optional)<br>
...
5. Combine summary tables  (optional)<br>
...
6. Make a new strain/ID list for use next time (optional)<br>
